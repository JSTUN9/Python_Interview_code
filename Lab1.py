...
class Lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab QPSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab QPSK")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(1.0,samp_rate,samp_rate/sps,0.35,128)
        self.noise_amp = noise_amp = 0
        self.constellation_0 = constellation_0 = digital.constellation_qpsk().base()
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine(1.0,self.samp_rate,self.samp_rate/self.sps,0.35,128))
